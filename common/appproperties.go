...
import (
	...
	"github.com/zzhtl/goxml/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/zzhtl/goxml")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/zzhtl/goxml
